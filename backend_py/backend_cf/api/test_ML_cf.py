...
filtered_rating_data = [obj for obj in rating_data if 'user_id' in obj]
...
rate = rate.loc[rate['rating'].notnull()]
...
def run_analyze(user_id):
    ...
    print('jumlah rata2 dan rating per merek:\n', agg_rate, '\n')
...
# user similarity menggunakan pearson correlation
    ...
    sim_user = user_sim[user_sim[picked_user_id] >
                        user_sim_threshold][picked_user_id].sort_values()[:n]
